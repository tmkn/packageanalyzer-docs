...
## Introduction
In this devblog I'll talk about how the project crashed and burned (also the unit tests) while I was on vacation in 🇨🇴 and how I use Jest's snapshots feature to test the CLI for the correct output.
<!--truncate-->
## Colombia
