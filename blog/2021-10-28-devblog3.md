...
As can be seen in the screenshot it cannot resolve the dependencies. Weird, maybe the internet connection of the hotel is blocking NPM but why could it install the dependencies just fine?
